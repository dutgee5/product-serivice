package com.eleiatech.stockmanagement.productserivice.exception.utils;
...
@Slf4j
@UtilityClass // arka tarafta finaly olarak işaretleniyor
public class FriendlyMessageUtils {
    ...
    public static  String getFriendlyMessage(Language language, IFriendlyMessageCode messageCode){
        ...
        try{
            ...
            messageKey=messageKey.getClass().getSimpleName()+SPECIAL_CHARACTER+messageCode;
